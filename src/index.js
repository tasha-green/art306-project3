...
function init() {
  ...
  audioLoad.load("/sound/Whisper_Loud.wav", function (buffer) {
    ...
    whisper_loud.setRefDistance(100);
  ...
  lightTwo(0.7, 1.0, 0.65, -250, 0, -4000, whisper, low_chord); //purple
